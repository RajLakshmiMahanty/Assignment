...
export default function List(props) {
  const cardCount = useRef(0); // Initialize cardCount with useRef
          ...
          <div className="list-header-left">
                            ...
                            >
                              <g fill="currentColor">
                                <path
                                  ...
                                  clip-rule="evenodd"
                                />
                                <path d="M6 33a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3v-6Zm3-1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1H9Z" />
                              </g>
                            </svg>
                          </div>
                        ),
            ...
            <div className="list-title">
              {props.groupValue === "priority"
                ? props.priorityList.filter(
                    (priority) => priority.priority === props.listTitle
                  )[0]?.name
                : props.listTitle}
            </div>
            <div className="list-sum">
              {
                (cardCount.current = props.ticketDetails.filter((ticket) => {
